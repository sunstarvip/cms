...
<xqlc:extends name="body">
   ...
   <!-- 人员选择器 -->
    ...
    <div class="widget-content">
		<form:form id="editForm" action="" modelAttribute="category" 
                ...
                <ul>
                  ...
                  <li class="fullWidth">
                   ...
                   <li id="categoryCheck" style="display:none">
                    ...
                    <div class="formright">
                     <c:if test="${not empty category.categoryCheckUser }">
                               
                               <xqlc:ajaxSelect id="type_roleIds_c" name="roleIds_c" url="${ctx}/platform/account/role.json" multiple="true"
	                               formatResult="formatResult" formatSelection="formatSelection" value="${roleIds_c_id}" valueInfo="${roleIds_c_s}"/>
                               ...
                               <c:if test="${empty category.categoryCheckUser }">
                   ...
                   <div class="formright">
                   <c:if test="${not empty category.contentCheckUser }">
                               
                               <xqlc:ajaxSelect id="type_roleIds_con" name="roleIds_con" url="${ctx}/platform/account/role.json" multiple="true"
	                               formatResult="formatResult" formatSelection="formatSelection" value="${roleIds_con_id}" valueInfo="${roleIds_con_s}"/>
						          <span id="owners_id" style="display: none;"></span>
						           <script type="text/javascript">
						           function formatResult(data) {
						           	return '<h5>' + data.name + '</h5>';
                               ...
                               <c:if test="${empty category.contentCheckUser }">
                   ...
                   <div class="formright">
                    <c:if test="${not empty category.reviewCheckUser }">
                                
                                <xqlc:ajaxSelect id="type_roleIds_pin" name="roleIds_pin" url="${ctx}/platform/account/role.json" multiple="true"
	                               formatResult="formatResult" formatSelection="formatSelection" value="${roleIds_pin_id}" valueInfo="${roleIds_pin_s}"/>
						          <span id="owners_id" style="display: none;"></span>
						           <script type="text/javascript">
						           function formatResult(data) {
						           	return '<h5>' + data.name + '</h5>';
                                ...
                                <c:if test="${empty category.reviewCheckUser }">
                   ...
                   <input type="hidden" id="oldPath" name="oldPath" value="${category.logoImage}" >
                   ...
                   <div class="formright">
                    <c:if test="${not empty category.accessUser }">
                                ...
                                <xqlc:ajaxSelect id="type_roleIds" name="roleIds" url="${ctx}/platform/account/role.json" multiple="true"
                                 ...
                                 <c:if test="${empty category.accessUser }">
                   ...
                   <div class="formright">
                    <c:if test="${not empty category.operateUser }">
                               <xqlc:ajaxSelect id="type_roleIds_p" name="roleIds_p" url="${ctx}/platform/account/role.json" multiple="true"
	                               formatResult="formatResult" formatSelection="formatSelection" value="${roleIds_p_id}" valueInfo="${roleIds_p_s}"/>
						          <span id="owners_id" style="display: none;"></span>
						           <script type="text/javascript">
						           function formatResult(data) {
						           	return '<h5>' + data.name + '</h5>';
                               ...
                               <c:if test="${empty category.operateUser }">
                               <xqlc:ajaxSelect id="type_roleIds_p" name="roleIds_p" url="${ctx}/platform/account/role.json" multiple="true"
...
<xqlc:extends name="javascript">
	...
	$(function() {
		...
		$("#englishName").on('blur',function() {
        	...
        	if(!(/^[A-Za-z0-9]+$/.test(result))) {
        		$("#checkEname").html("<font color='#B94A48'>${xqlc:i18n('ui.cms.siteEnameCheck',locale)}</font>");
        	};
	...
	$(function() {
		...
		}else if(value =="yes"&& $('#auditCatcontentMethod').val()=="2"){
		...
		var value = $('#reviewCatcontent').val();
			if(value == ""||value == "no") {
				...
				$("#reviewCheck").hide();
			} else if(value == "yes" && $('#auditCatreview').val()=="yes" && $('#auditCatreviewMethod').val()=="2"){
				$("#auditAssess").show();
	...
	$(function() {
		...
		$('#saveType_btn').click(function() {
            ...
            $('#editForm')[0].action = "${ctx}/cms/category/updateSave";
                  $('#editForm').submit();
        }); 
    });
