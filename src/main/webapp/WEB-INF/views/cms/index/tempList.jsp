...
<xqlc:extends name="nav">
    ...
    <ul>
        ...
        <li class="active">
            <a href="${ctx}/cms/index/templist" id="templateManagement">
            <i class="icon-user"></i>
...
<xqlc:extends name="content">
    ...
    <form id="queryForm" action="${ctx}/cms/index/templist">
        ...
        <xqlc:table id="queryTable" items="${pageInfo}">
            <xqlc:row var="site">
                ...
                <xqlc:column title="${xqlc:i18n('ui.cms.manipulate',locale)}">
                    <!-- 选择站点 -->
                    <a class="tip-top btn btn-success" href="${ctx}/cms/template/temp?tempId=${site.id }">
