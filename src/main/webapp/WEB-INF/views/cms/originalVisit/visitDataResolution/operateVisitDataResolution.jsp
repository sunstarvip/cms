...
<xqlc:extends name="body">
    <form id="countForm" action="" method="get">
        <div class="widget-content">
            <table class="table table-striped table-bordered table-hover" id="resolutionTable">
                <thead>
                    <tr>
                        <td>分辨率类型</td>
                        <td>访问量</td>
                ...
                <tbody>
                    <c:forEach items="${resolutionVisitDataList}" var="resolutionVisitData">
                        <tr>
                            <td>${resolutionVisitData[0]}</td>
                            <td>${resolutionVisitData[1]}</td>
                            <td class="stop">
