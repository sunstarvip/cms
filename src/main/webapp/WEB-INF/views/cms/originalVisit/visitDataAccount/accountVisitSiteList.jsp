...
<xqlc:extends name="javascript">
    <script type="text/javascript">
        function checkOperate(siteId){
            $('#opereateIframe').attr('src','${ctx}/cms/original/visitDataAccount?siteId='+siteId);
            $('#operateModal').modal();
        }
        ...
        $(function() {
            ...
            $('#siteTable tbody tr').on('click', function() {
                $('#myIframe').attr('src','${ctx}/cms/original/visitDataAccount?siteId='+$(this).attr('data-row-id'));
                $('#myModal').modal();
            });
...
<xqlc:extends name="body">
    <div class="appcontent">
        <h3>
            <span style="font-size: x-large;">账号统计</span>
        </h3>
    </div>
