...
<xqlc:extends name="javascript">
    <script type="text/javascript">
        function checkOperate(siteId){
            $('#myIframe').attr('src','${ctx}/cms/original/visitDataIp?siteId='+siteId);
            $('#myModal').modal();
        }
        ...
        $(function() {
            ...
            $('#siteTable tbody tr').on('click', function() {
                $('#operateIframe').attr('src','${ctx}/cms/original/visitDataIp?siteId='+$(this).attr('data-row-id'));
                $('#operateModal').modal();
            });
...
<xqlc:extends name="body">
    <div class="appcontent">
        <h3>
            <span style="font-size: x-large;">IP统计</span>
        </h3>
    </div>
