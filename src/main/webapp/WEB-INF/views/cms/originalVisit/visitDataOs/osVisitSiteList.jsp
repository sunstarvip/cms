...
<xqlc:extends name="javascript">
    <script type="text/javascript">
        function checkOperate(siteId){
            $('#operateIframe').attr('src','${ctx}/cms/original/visitDataOs?siteId='+siteId);
            $('#operateModal').modal();
        }
        ...
        $(function() {
            ...
            $('#siteTable tbody tr').on('click', function() {
                $('#myIframe').attr('src','${ctx}/cms/original/visitDataOs?siteId='+$(this).attr('data-row-id'));
                $('#myModal').modal();
            });
...
<xqlc:extends name="body">
    <div class="appcontent">
        <h3>
            <span style="font-size: x-large;">操作系统统计</span>
        </h3>
    </div>
